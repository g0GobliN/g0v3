          ...
          <div className="col-span-8">
            ...
            <header className="mb-6 sm:mb-8">
              ...
              <div className={`${c.main} text-xs mb-3 sm:mb-6`}>
                {
                  magazineSections.find((s) => s.id === currentSection)
                    ?.subtitle
                }
              </div>
            ...
            >
              ...
              <div className="mb-4 sm:mb-8">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div>
                    <div
                      className={`${c.fade} text-xs uppercase tracking-wide`}
                    >
                      location
                    </div>
              ...
              >
                ...
                >
                  Making small apps, practicing coding, and discovering new ways
                  to solve problems.
                </div>
              </div>
            </div>
